...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **0 — Architecture** ✅ | repo, Vite/TS/ESLint/Prettier/Vitest/Playwright, `core/` com fronteira aplicada por lint, event bus, tuning, save, manifesto, scale handler, debug, CI                                                              | —                                   | **concluída** — `npm run ci` verde; 87 testes unitários; 16 testes de browser                                                                                                                 |
